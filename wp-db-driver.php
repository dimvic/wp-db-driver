...
class WP_DB_Driver_Plugin
{
    ...
    public function __construct()
    {
        ...
        add_action('admin_init', [$this, 'remove_emergency_cookie']);
    }
    ...
    public function page_overview()
    {
        ...
        if (file_exists(WP_CONTENT_DIR . '/db.php')) {
            ...
            if ($crc1 === $crc2) {
                ...
                echo '<p><strong>' . call_user_func([WP_DB_Driver_Config::get_current_driver(), 'get_name']) . '</strong> &nbsp; ';
        ...
        foreach ($drivers as $driver => $file) {
            ...
            echo '<tr>';
            echo '<th>' . call_user_func([$driver, 'get_name']) . '</th>';
            echo '<td>';

            if (call_user_func([$driver, 'is_supported'])) {
...
register_uninstall_hook(__FILE__, ['WP_DB_Driver_Plugin', 'uninstall']);
